...
<body class="bg-surface text-on-background min-h-screen">
    ...
    <main class="ml-64 pt-28 px-10 pb-20">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <section class="lg:col-span-2 space-y-6">
                <div class="flex items-center justify-between">
                    <h2 class="text-2xl font-bold text-on-surface">Ceftificates Requests</h2>
        ...
        <section class="mt-16">
            <h2 class="text-2xl font-bold text-on-surface mb-8">Platform Traffic Activity</h2>
            <div class="bg-surface-container-low h-64 rounded-2xl flex items-end p-8 gap-4">
                <div class="flex-1 bg-primary-container/20 rounded-t-lg h-24 relative group">
                    <div
                        class="absolute inset-0 bg-primary opacity-0 group-hover:opacity-100 transition-opacity rounded-t-lg h-24">
                    </div>
                </div>
                <div class="flex-1 bg-primary-container/20 rounded-t-lg h-40 relative group">
                    <div
                        class="absolute inset-0 bg-primary opacity-0 group-hover:opacity-100 transition-opacity rounded-t-lg h-40">
                    </div>
                </div>
                <div class="flex-1 bg-primary-container/20 rounded-t-lg h-32 relative group">
                    <div
                        class="absolute inset-0 bg-primary opacity-0 group-hover:opacity-100 transition-opacity rounded-t-lg h-32">
                    </div>
                </div>
                <div class="flex-1 bg-primary-container/20 rounded-t-lg h-56 relative group">
                    <div
                        class="absolute inset-0 bg-primary opacity-0 group-hover:opacity-100 transition-opacity rounded-t-lg h-56">
                    </div>
                </div>
                <div class="flex-1 bg-primary-container/20 rounded-t-lg h-44 relative group">
                    <div
                        class="absolute inset-0 bg-primary opacity-0 group-hover:opacity-100 transition-opacity rounded-t-lg h-44">
                    </div>
                </div>
                <div class="flex-1 bg-primary-container/20 rounded-t-lg h-48 relative group">
                    <div
                        class="absolute inset-0 bg-primary opacity-0 group-hover:opacity-100 transition-opacity rounded-t-lg h-48">
                    </div>
                </div>
                <div class="flex-1 bg-primary-container/20 rounded-t-lg h-60 relative group">
                    <div
                        class="absolute inset-0 bg-primary opacity-0 group-hover:opacity-100 transition-opacity rounded-t-lg h-60">
                    </div>
                </div>
                <div class="flex-1 bg-primary-container/20 rounded-t-lg h-52 relative group">
                    <div
                        class="absolute inset-0 bg-primary opacity-0 group-hover:opacity-100 transition-opacity rounded-t-lg h-52">
                    </div>
                </div>
                <div class="flex-1 bg-primary-container/20 rounded-t-lg h-36 relative group">
                    <div
                        class="absolute inset-0 bg-primary opacity-0 group-hover:opacity-100 transition-opacity rounded-t-lg h-36">
                    </div>
                </div>
                <div class="flex-1 bg-primary-container/20 rounded-t-lg h-28 relative group">
                    <div
                        class="absolute inset-0 bg-primary opacity-0 group-hover:opacity-100 transition-opacity rounded-t-lg h-28">
                    </div>
                </div>
                <div class="flex-1 bg-primary-container/20 rounded-t-lg h-38 relative group">
                    <div
                        class="absolute inset-0 bg-primary opacity-0 group-hover:opacity-100 transition-opacity rounded-t-lg h-38">
                    </div>
                </div>
                <div class="flex-1 bg-primary-container/20 rounded-t-lg h-42 relative group">
                    <div
                        class="absolute inset-0 bg-primary opacity-0 group-hover:opacity-100 transition-opacity rounded-t-lg h-42">
                    </div>
                </div>
            </div>
