<header
    class="fixed top-0 left-0 right-0 z-40 backdrop-blur-md bg-white/70 dark:bg-slate-900/70 border-b border-slate-200 dark:border-slate-800">
    <div class="max-w-7xl mx-auto h-16 flex items-center justify-between px-6">
        ...
        <div class="flex items-center gap-4">
            ...
            @guest
                <div class="flex items-center gap-3">
                    <a href="/login" class="text-sm text-slate-600 hover:text-primary transition">
                        Sign In
                    </a>

                    <a href="/register"
                        class="px-4 py-2 bg-primary text-white text-sm rounded-full hover:opacity-90 transition">
                        Sign Up
                    </a>
                </div>
            @endguest
