...
<h1 class="text-xl font-bold tracking-tight text-white uppercase tracking-widest">LearnxChange</h1>
</div>
...
<span class="material-symbols-outlined text-primary text-3xl neon-text-glow">database</span>
<h1 class="text-xl font-black tracking-widest text-white uppercase italic">LearnxChange</h1>
</div>
...
<p class="text-[10px] font-black uppercase tracking-widest text-slate-600">© 2024 LearnxChange HUB // PROTOCOL v4.0.2</p>
