    ...
    <div class="flex min-h-screen">
        <aside class="w-64 bg-sidebar-bg border-r border-border-color flex flex-col fixed h-full z-20">
            ...
            <div class="px-4 py-2">
                ...
                <nav class="space-y-1">
                    <a class="flex items-center gap-3 px-3 py-2 rounded-lg bg-primary/10 text-primary font-medium border border-primary/20"
                        href="#">
                        <span class="material-symbols-outlined">dashboard</span>
                        <span>Dashboard</span>
                    </a>
                    <a class="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-400 hover:bg-card-bg hover:text-white transition-colors"
                        href="#">
            ...
            <div class="mt-auto p-4 border-t border-border-color">
                <div
                    class="flex items-center justify-between px-3 py-4 bg-card-bg rounded-xl border border-border-color mb-4">
                ...
                <button
                    class="w-full flex items-center justify-center gap-2 bg-primary text-black py-2.5 px-4 rounded-lg font-bold text-sm hover:bg-primary/90 transition-all shadow-[0_0_15px_rgba(57,255,20,0.3)]">
        ...
        <main class="ml-64 flex-1 p-8 min-h-screen bg-dark-bg">
            <div class="flex justify-between items-end mb-8">
                <div>
                    <h1 class="text-3xl font-black tracking-tight text-white">Welcome back, <span
                            class="text-primary">Alex!</span></h1>
                ...
                <div class="flex items-center gap-4 bg-sidebar-bg p-3 rounded-xl border border-border-color">
                    <div
                        class="flex items-center gap-2 px-3 py-1 bg-primary/10 text-primary rounded-full font-bold border border-primary/20">
                        <span class="material-symbols-outlined text-[20px]">potted_plant</span>
                        <span>Level 14</span>
                    </div>
                    <div class="h-6 w-px bg-border-color"></div>
                    <div
                        class="flex items-center gap-2 px-3 py-1 bg-primary/20 text-primary rounded-full font-bold border border-primary/40">
                ...
                <div class="col-span-8 space-y-8">
                    <section class="bg-sidebar-bg rounded-xl p-6 border border-border-color">
                        ...
                        <div class="space-y-6">
                            <div class="group">
                                ...
                                <div
                                    class="w-full bg-slate-900 h-2.5 rounded-full overflow-hidden border border-border-color">
                                    <div class="bg-primary h-full transition-all shadow-[0_0_8px_rgba(57,255,20,0.5)]"
                                        style="width: 75%;"></div>
                                </div>
                    ...
                    <section class="bg-sidebar-bg rounded-xl p-6 border border-border-color">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <button
                                class="text-sm text-primary font-semibold flex items-center gap-1 hover:brightness-110">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div
                                class="p-4 rounded-xl border border-border-color bg-card-bg/50 flex flex-col gap-4 hover:border-primary/30 transition-all">
                                <div class="flex justify-between items-start">
                                    <div
                                        class="px-2 py-1 rounded bg-primary/10 border border-primary/20 text-primary text-[10px] font-bold uppercase tracking-wider">
                                        Group Session</div>
                                ...
                                <div class="flex items-center justify-between mt-2">
                                    <div class="flex -space-x-2">
                                        <div class="size-7 rounded-full border-2 border-sidebar-bg bg-cover bg-center"
                            ...
                            <div
                                ...
                                <div class="flex justify-between items-start">
                                    <div
                                        class="px-2 py-1 rounded bg-slate-800 border border-border-color text-slate-300 text-[10px] font-bold uppercase tracking-wider">
                                        1-on-1 Mentorship</div>
                                ...
                                <div class="flex items-center justify-between mt-2">
                                    <div class="flex items-center gap-2">
                                        <div class="size-7 rounded-full border-2 border-sidebar-bg bg-cover bg-center"
                                            style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuDEAtAFEL44EvPcfmxWUhl-LUdplM-vii4_7eJWnPex6ot4Q_AtrhQS704T5Oy3cVrNrLNQ61V--NR_oZgxw9v0ESkVWKyNmenJBbpoCdbgJ9CfbS8HvQykcBpJR-pUjyZmpe1oJAP3Gi1FzM6Thhfk6YMKvB9ChbdxX0P3hs1pMcyWWOlu_nWJ8O77B7YsenBkoaPabxgffzQbZvXcLkW3-lMt-BPMmLglfYX2frWBmKftiUbEcm6TG1uyvMTXbQPtdNMxLn2rMjRg')">
                                        </div>
                                        <span class="text-xs font-medium text-slate-400">David C.</span>
                                    </div>
                                    <button
                                        class="border border-primary text-primary text-xs px-4 py-1.5 rounded-lg font-bold hover:bg-primary/10 transition-all">Details</button>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="bg-sidebar-bg rounded-xl p-6 border border-border-color overflow-hidden relative">
                        ...
                        <div class="grid grid-cols-3 gap-3 relative z-10">
                            <div class="flex flex-col items-center gap-2">
                                <div
                                    class="size-14 rounded-xl bg-primary/10 flex items-center justify-center text-primary border border-primary/20">
                                    <span class="material-symbols-outlined text-3xl">workspace_premium</span>
                                </div>
                                <span class="text-[10px] font-bold text-center leading-tight text-slate-300">Fast
                                    Learner</span>
                            </div>
                            <div class="flex flex-col items-center gap-2">
                                <div
                                ...
                                <span class="text-[10px] font-bold text-center leading-tight text-slate-300">7 Day
                                    Streak</span>
                            </div>
                            <div class="flex flex-col items-center gap-2">
                                <div
                                ...
                                <span class="text-[10px] font-bold text-center leading-tight text-slate-300">Problem
                                    Solver</span>
                            </div>
                        </div>
                        <button
                            class="w-full mt-6 py-2 border border-border-color rounded-lg text-sm font-semibold text-slate-400 hover:text-primary hover:border-primary/30 transition-all">
                            View Trophy Room
                        </button>
                    </section>
                    <section class="bg-sidebar-bg rounded-xl p-6 border border-border-color">
                        ...
                        <div class="space-y-4">
                            <div
                                class="flex items-center gap-4 group cursor-pointer p-2 rounded-lg hover:bg-card-bg transition-all">
                                <div class="relative">
                                    <div class="size-12 rounded-lg bg-cover bg-center border border-border-color"
                                    ...
                                    <div
                                        class="absolute -bottom-1 -right-1 size-3 bg-primary rounded-full border-2 border-sidebar-bg">
                                    </div>
                                </div>
                                <div class="flex-1">
                                    <h4
                            ...
                            <div
                                ...
                                <div class="relative">
                                    ...
                                    <div
                                        class="absolute -bottom-1 -right-1 size-3 bg-slate-600 rounded-full border-2 border-sidebar-bg">
                                    </div>
                                </div>
                                <div class="flex-1">
                                    <h4
                        ...
                        <button
                            class="w-full mt-6 py-2 bg-primary text-black rounded-lg text-sm font-bold hover:brightness-110 transition-all shadow-[0_0_10px_rgba(57,255,20,0.2)]">
                            Browse Mentors
                        </button>
                    </section>
                </div>
